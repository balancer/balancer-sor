...
const swapAmount = new BigNumber('10000000000000000000000'); // 10000
const maxPaths = new BigNumber('10');
const returnTokenCostPerPool = new BigNumber('1000000000000000'); // It costs 0.0001 returnToken per pool trade
