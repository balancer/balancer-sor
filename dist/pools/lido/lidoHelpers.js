    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (swapType === types_1.SwapTypes.SwapExactIn)
                return bmath_1.bnum(deltas[assets.length - 1].toString()).times(-1);
            else
                return bmath_1.bnum(deltas[0].toString());
        }
        catch (err) {
...
function getLidoStaticSwaps(pools, chainId, tokenIn, tokenOut, swapType, swapAmount, provider) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (swapType === types_1.SwapTypes.SwapExactIn)
            swapInfo.swapAmount = bmath_1.scale(swapAmount, staticRoute.tokenInDecimals).dp(0);
        else
            swapInfo.swapAmount = bmath_1.scale(swapAmount, staticRoute.tokenOutDecimals).dp(0);
