    ...
    setCostOutputToken(tokenOut, tokenDecimals, cost = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (cost === null) {
                ...
                const costOutputToken = yield index_1.getCostOutputToken(tokenOut, this.gasPrice, this.swapCost, this.provider, this.chainId);
                this.tokenCost[tokenOut] = costOutputToken.div(index_1.bnum(Math.pow(10, tokenDecimals)));
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (isExternalPoolData) {
                    ...
                    if (this.isUsingPoolsUrl)
                        subgraphPools = yield index_1.fetchSubgraphPools(this.poolsUrl);
                    else
    ...
    */
    fetchOnChainBalances(subgraphPools, isOnChain = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const onChainPools = yield index_1.getOnChainBalances(subgraphPools, index_1.MULTIADDR[this.chainId], index_1.VAULTADDR[this.chainId], this.provider);
    ...
    getSwaps(tokenIn, tokenOut, swapType, swapAmt, swapOptions = {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const wrappedInfo = yield index_1.getWrappedInfo(this.provider, swapType, tokenIn, tokenOut, this.chainId, swapAmt);
            if (this.finishedFetchingOnChain) {
                ...
                if (index_1.isLidoStableSwap(this.chainId, tokenIn, tokenOut)) {
                    swapInfo = yield index_1.getLidoStaticSwaps(pools, this.chainId, wrappedInfo.tokenIn.addressForSwaps, wrappedInfo.tokenOut.addressForSwaps, swapType, wrappedInfo.swapAmountForSwaps, this.provider);
                }
                else {
                    swapInfo = yield this.processSwaps(wrappedInfo.tokenIn.addressForSwaps, wrappedInfo.tokenOut.addressForSwaps, swapType, wrappedInfo.swapAmountForSwaps, pools, true, swapOptions.timestamp);
                }
                if (swapInfo.returnAmount.isZero())
                    return swapInfo;
                swapInfo = index_1.setWrappedInfo(swapInfo, swapType, wrappedInfo, this.chainId);
            }
            return swapInfo;
        });
    }
    ...
    processSwaps(tokenIn, tokenOut, swapType, swapAmt, onChainPools, useProcessCache = true, currentBlockTimestamp = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!useProcessCache || !cache) {
                ...
                let pathData;
                let hopTokens;
                [pools, hopTokens] = index_1.filterPoolsOfInterest(poolsList.pools, tokenIn, tokenOut, this.maxPools, this.disabledOptions, currentBlockTimestamp);
                [pools, pathData] = index_1.filterHopPools(tokenIn, tokenOut, hopTokens, pools);
            ...
            [swaps, total, marketSp, totalConsideringFees] = index_1.smartOrderRouter(JSON.parse(JSON.stringify(pools)), // Need to keep original pools for cache
            ...
            swapInfo = index_1.formatSwaps(swaps, swapType, swapAmt, tokenIn, tokenOut, total, totalConsideringFees, marketSp);
            return swapInfo;
        });
    }
}
