        ...
        if (path.swaps.length == 1) {
            ...
            let tI = pool.tokens.find(
                t =>
                    ...
                    ethers_1.ethers.utils.getAddress(swap2.tokenIn)
            );
            let decimalsIn = tI.decimals;
            console.log(`SWAPAMOUNT`);
            console.log(swapAmount.toString());
            swapAmount = bmath_1.scale(swapAmount, -18);
            swapAmount = bmath_1.scale(swapAmount, decimalsIn);
            console.log(swapAmount.toString());
            if (swapType !== 'swapExactIn')
                swapAmount = helpers_1.getReturnAmountSwap(
                    pools,
                    poolPairDataSwap2,
                    swapType,
                    swapAmount
            ...
            tI = pool.tokens.find(
                t =>
                    ethers_1.ethers.utils.getAddress(t.address) ===
                    ethers_1.ethers.utils.getAddress(swap1.tokenIn)
            );
